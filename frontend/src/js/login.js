...
export default function login() {
	...
	const divRow = new ClassElement('div', 'row row-gap-3 justify-content-center align-items-center w-50 position-relative', 'loginRow', '');
	const	headerText = new ClassElement('h1', 'text-center text-light', 'loginHeader', 'Pong Game');
	...
	const labelEmail = new LabelElement('inputEmail','text-secondary', 'Email address');
	const inputEmail = new InputElement('email', 'form-control', 'inputEmail', 'Enter email');
	const labelPassword = new LabelElement('inputPassword', 'text-secondary', 'Password');
